...
public class TypeACurveGenerator implements PairingParametersGenerator {
    ...
    public PairingParameters generate() {
        ...
        params.put("type", "a");
        params.put("q", "2530347915464266888147489067789247006866643207146949008986186217633528106964625981647804428149399729236952065491307177730584774185025935130437521051393051");
        params.put("r", "730750862221594424981965739670091261094297337857");
        params.put("h", "3462668395315500669480325110620131433818912085028730192186874025814560448846494449929468371801654008388636");
        params.put("exp1", "135");
        params.put("exp2", "159");
        params.put("sign0", "1");
        params.put("sign1", "1");
